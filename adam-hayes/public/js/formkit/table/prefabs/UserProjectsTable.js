...
BlueBox.compose('formkit.table.prefabs.UserProjectsTable', function(_class, _proto, _super) {
	...
	.startTable()
		...
		.setTitleRow()
			.setRowRenderer(function(row) {
				...
				row.attr("style","background:#F2F2F2; font-weight:bold; padding-top:7px; padding-bottom:7px; border-bottom:5px solid#4131d6;");
				})
