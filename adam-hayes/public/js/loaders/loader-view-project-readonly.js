...
mainPageLoader.enqueue("/js/util/resizers/GreedyVerticalImageContainer.js");
...
mainPageLoader.enqueue("/js/ajax/inputs/CheckBoxGroup.js");
...
mainPageLoader.enqueue("/js/ajax/clients/RequestJoinProject.js");
mainPageLoader.enqueue("/js/ajax/servers/BaseServerInterface.js");
mainPageLoader.enqueue("/js/ajax/servers/LaravelServer.js");

    // if(useAlexDebug) {
    // mainPageLoader.enqueue("/js/ajax/clients/StripeDonation.js");
    // mainPageLoader.enqueue("/js/ajax/clients/StripeAddProjectCard.js");
    // mainPageLoader.enqueue("/js/applications/AppViewProjectReadOnly.js");
    // mainPageLoader.enqueue("https://js.stripe.com/v3/", null, "js");
    // } else {
    mainPageLoader.enqueue("/js/applications/AppViewProjectReadOnly.js");
    //}
...
mainPageLoader.resolveQueue(
    function(){
    $(document).ready(blue.applications.AppViewProjectReadOnly.bootstrap());
    });
