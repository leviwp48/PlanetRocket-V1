			...
			<!-- Alec's Attempts at adding date/time functionality -->
			 ...
			 <div class="h-group switch-to-rows" style="margin-top:35px;">
                ...
                <div class="box" style="width:23.3%;">
                  <?php echo Form::selectRange('daynum', 1, 31, null,['style'=>'font-size:115%;']); ?>
                </div>
...
?>
                 ...
                 <div class="box" style="width:23.4%;">
                  <?php echo Form::select('month', $months, null, ['style'=>'font-size:115%;']); ?>
                </div>
                
                 <div class="box" style="width:23.3%;">
                  <?php echo Form::selectyear('pyear', 2018, 2118, null, ['style'=>'font-size:115%;']); ?>
                </div>
                ...
                <div class="box" style="width:5%;">
                  <?php echo Form::selectRange('hour', 1, 12, null,['style'=>'font-size:115%;']); ?>
                </div>
                
                <div class="box" style="width:1%;"><h3>:</h3></div>
                
                 <div class="box" style="width:8%;">
                  <?php echo Form::select('minute', array('00' => '00', '15' => '15', '30' => '30', '45' => '45'), null, ['style'=>'font-size:115%;']); ?>
                </div>
                
                <div class="box" style="width:11.675%;">
                  <?php echo Form::select('amORpm', array('am' => 'AM', 'pm' => 'PM'), null, ['style'=>'font-size:115%;']); ?>
                </div>
                ...
                <div class="box" style="width:12%;">
             		<?php echo Form::select('reoccur', array('none' => "it doesn't", 'daily' => 'every day', 'weekly' => 'every week', 'monthly' => 'every month', 'yearly' => 'every year'), null,['style'=>'font-size:115%;']); ?>
                </div>
                ...
                <div class="box" style="width:35%;">
                	 <?php echo Form::selectRange('reoccurdaynum', 1, 31, null,['style'=>'font-size:115%;']); ?>
                 	 <?php echo Form::select('reoccurmonth', $months, null, ['style'=>'font-size:115%;']); ?>
                 	 <?php  echo Form::selectyear('reoccuryear', 2018, 2118, null, ['style'=>'font-size:115%;']); ?>
                </div>
                </div>
