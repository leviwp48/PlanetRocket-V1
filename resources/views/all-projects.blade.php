            ...
            <div class="center_column" style="width:90%; max-width:1200px; height:100%; background:#FFFFFF;">
              ...
              <div class="row" style="margin-top:20px;">
                ...
                <?php
                  if($user) {
                  ?>
                    <a href="/adam-hayes/public/user/new-project">
                      <div class="box formstyles-button">Create a new project!</div>
                    </a>
                    <a href="/adam-hayes/public/user/projects">
                      <div class="box formstyles-button">See your current projects</div>
                    </a>
                  <?php
                  } else {
                  ?>
                    <a href="/adam-hayes/public/login">
                      <div class="box formstyles-button" style="background:#66b517;">Login or signup!</div>
                    </a>
                  <?php
                  }
              ...
              <div class="row" style="margin-top:20px;"><h2>Browse our projects</h2></div>
