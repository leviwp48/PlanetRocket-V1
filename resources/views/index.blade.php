...
<link rel="stylesheet" id="alex-lowe-core-layout" href="{{ asset('css/alex-lowe-core-layout.css')}}" type="text/css" media="all">
<link rel="stylesheet" id="about-page" href="{{ asset('css/index-page.css')}}" type="text/css" media="all">
<link rel="stylesheet" id="gbc-main" href="{{ asset('css/gbc-css/gbc-main.css')}}" type="text/css" media="all">
<script type="text/javascript" src="{{ asset('js/lib/html5.js')}}"></script>
      ...
      <div class="v-inner">
          <div class="box" style="height:100%; background:#FFFFFF;">
            ...
            <div class="h-group" style="margin-top:30px;">
              <div class="box icon-width" style="padding-left:10px; padding-right:10px; vertical-align:middle;">
                <div class="img-wrap-w-center">
                  <img class="box" alt="For Individuals" src="/adam-hayes/public/images/home-page-individuals.png">
                </div>
              </div>
            ...
            <div class="h-group" style="margin-top:30px;">
              <div class="box icon-width" style="padding-left:10px; padding-right:10px; vertical-align:middle;">
                <div class="img-wrap-w-center">
                  <img class="box" alt="For Groups" src="/adam-hayes/public/images/home-page-groups.png">
                </div>
              </div>
              <div class="box" style="vertical-align:middle;">
            ...
            <div class="h-group" style="margin-top:30px;">
              <div class="box icon-width" style="padding-left:10px; padding-right:10px; vertical-align:middle;">
                <div class="img-wrap-w-center">
                  <img class="box" alt="For Groups" src="/adam-hayes/public/images/home-page-entrepreneurs.png">
                </div>
              </div>
              <div class="box" style="vertical-align:middle;">
            ...
            <div class="h-group" style="margin-top:30px;">
              <div class="box icon-width" style="padding-left:10px; padding-right:10px; vertical-align:middle;">
                <div class="img-wrap-w-center">
                  <img class="box" alt="For Groups" src="/adam-hayes/public/images/home-page-nonprofits.png">
                </div>
              </div>
              <div class="box" style="vertical-align:middle;">
            ...
            <div class="h-group" style="margin-top:30px;">
              <div class="box icon-width" style="padding-left:10px; padding-right:10px; vertical-align:middle;">
                <div class="img-wrap-w-center">
                  <img class="box" alt="For Groups" src="/adam-hayes/public/images/home-page-companies.png">
                </div>
              </div>
              <div class="box" style="vertical-align:middle;">
