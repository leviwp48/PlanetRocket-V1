...
console.log("loader-all-projects");
...
mainPageLoader.enqueue("/js/formkit/table/servers/Laravel.js");
mainPageLoader.enqueue("/js/formkit/table/Table.js");
mainPageLoader.enqueue("/js/formkit/table/prefabs/AllProjectsTable.js");

mainPageLoader.enqueue("/js/applications/AppAllProjects.js");

//load up the queue
mainPageLoader.resolveQueue(
    function(){
    $(document).ready(blue.applications.AppAllProjects.bootstrap());
    });
