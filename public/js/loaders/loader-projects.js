...
mainPageLoader.enqueue("/js/formkit/table/prefabs/UserProjectsTable.js");

mainPageLoader.enqueue("/js/applications/AppProjects.js");

//load up the queue
mainPageLoader.resolveQueue(
    function(){
    $(document).ready(blue.applications.AppProjects.bootstrap());
    });
